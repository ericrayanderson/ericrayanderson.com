(function () {
  ...
  var stage = document.getElementById("heli-stage");
  var overlay = document.getElementById("heli-overlay");
  var overlayTitle = document.getElementById("heli-overlay-title");
  var overlayText = document.getElementById("heli-overlay-text");
  var startBtn = document.getElementById("heli-start");
  var scoreEl = document.getElementById("heli-score");
  var bestEl = document.getElementById("heli-best");
  var live = document.getElementById("heli-live");
